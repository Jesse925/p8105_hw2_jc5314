...
sheet has 344 observations. After omitting rows without precipitation
...
`pre_2018_data`, which is the precipitation data for 2018, has 12
observations. The combined precipitation dataset of 2017-18 has 24
observations.
...
variables in this dataset should be the `President` which indicates the
